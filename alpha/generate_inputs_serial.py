...
if __name__ == '__main__':
    start_index, end_index = 237, 2000
    ...
    index = start_index
    rd.seed(0)
    with open('cantherm_pdep_input_alpha_w_uncertainty_blanks.py', 'r') as f:
    ...
    if generate_templates:
        ...
        while index < end_index:
            ...
            index += 1
        random_values_df = pd.DataFrame(data=list_of_random_values, index=range(start_index, end_index), columns=column_names)
